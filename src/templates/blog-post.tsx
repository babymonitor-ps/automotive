	...
	return (
		<Layout>
			<SEO
				...
				thumbnail={urljoin(siteUrl, post.frontmatter.cover?.publicURL != null ? post.frontmatter.cover.publicURL : '')}
			/>
			<BlogPostDetailsWrapper>
				<PostDetails
					title={post.frontmatter.title}
					...
					<PrevButton>
						{next && (
							<Link to={'/' + next.fields.slug}>
								<ThumbImg>
									<GatsbyImage src={next.frontmatter.cover == null
										? null
										: next.frontmatter.cover.childImageSharp.gatsbyImageData} alt={next.frontmatter.title} />
								</ThumbImg>
								<PostInfo>
									<Text>
										<IoIosArrowBack />
